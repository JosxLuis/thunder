<?php
	if(isset($_POST['eliminar-foto']) && $_POST['eliminar-foto'] != ""){
		$portada = devolverValorQuery("SELECT avatar FROM ".DB_PREFIJO."usuario WHERE id".DB_PREFIJO."usuario=".$_GET['id']." ");
		if($portada['avatar'] != ""){
    		unlink("../".$portada['avatar']);
		}
		$borrarEntrada = "UPDATE ".DB_PREFIJO."administrador SET avatar = '' WHERE id".DB_PREFIJO."usuario= ".$_GET['id']."";
	...
	if(isset($_POST['cambiar-contrasena']) && $_POST['cambiar-contrasena'] != ""){
		...
		$cambiarContrasena = "UPDATE ".DB_PREFIJO."usuario SET token = '".md5($password)."' WHERE id".DB_PREFIJO."usuario= ".$_GET['id']."";
	...
	if(isset($_POST['editar']) && $_POST['correo'] != ""){
		$portada = "";
		...
		$editarPublicacion = "UPDATE ".DB_PREFIJO."usuario SET $portada nombre='".utf8_decode($_POST['nombre'])."', apellidos='".utf8_decode($_POST['apellidos'])."', correo='".utf8_decode($_POST['correo'])."' 
		WHERE id".DB_PREFIJO."usuario=".$_GET['id']." ";
	...
	$consulta = devolverValorQuery("SELECT * FROM ".DB_PREFIJO."usuario WHERE id".DB_PREFIJO."usuario=".$_GET['id']." ");
				...
				<div class="list-items">
					...
					<div class="form-add">
			        	<form name="form1" action="" method="post" enctype="multipart/form-data">
			        		...
			        		<div class="mintext">Si no selecionas una nueva foto se conserva la anterior</div>
