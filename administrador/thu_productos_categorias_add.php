<?php
	if(isset($_POST['editar']) && $_POST['marca'] != ""){
		...
		$insertarRegistro = "INSERT INTO ".DB_PREFIJO."categoria(id".DB_PREFIJO."categoria,id".DB_PREFIJO."administrador,id".DB_PREFIJO."marca,$categoriaAttr portada,nombre,descripcion,creado) VALUES (0,".$_SESSION[PREFIJO.'idadmin'].",".$_POST['marca'].", $categoriaVal '".$fotografia."','".utf8_decode($_POST['nombre'])."','".utf8_decode($_POST['descripcion'])."','".$fecha."')";
