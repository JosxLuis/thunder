<?php
	if(isset($_POST['proyecto_tipo']) && $_POST['proyecto_tipo'] != ""){
		...
		$insertarRegistro = "INSERT INTO ".DB_PREFIJO."servicio(id".DB_PREFIJO."servicio,id".DB_PREFIJO."administrador,id".DB_PREFIJO."proyecto_tipo,portada,icono,nombre,introduccion,descripcion,tags,creado) VALUES (0,".$_SESSION[PREFIJO.'idadmin'].",".$_POST['proyecto_tipo'].",'".$fotografia."','".utf8_decode($_POST['icono'])."','".utf8_decode($_POST['nombre'])."','".utf8_decode($_POST['introduccion'])."','".utf8_decode($_POST['descripcion'])."','".utf8_decode($_POST['tags'])."','".$fecha."')";
				...
				<div class="list-items">
			        ...
			        <div class="form-add">
			        	<form name="form1" action="" method="post" enctype="multipart/form-data">
			        		...
			        		<input type="text" name="icono" placeholder="Ej. icon-servicio" required>
