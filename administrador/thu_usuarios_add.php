<?php
	if(isset($_POST['editar']) && $_POST['nombre'] != ""){
		...
		$insertarRegistro = "INSERT INTO ".DB_PREFIJO."administrador(id".DB_PREFIJO."administrador,id".DB_PREFIJO."administrador_rol,usuario,token,avatar,nombre,apellidos,correo,telefono,creado) VALUES (0,".$_POST['tipoUsuario'].",
		'".$_POST['usuario']."','".md5($password)."','".$ruta_image_normal."','".utf8_decode($_POST['nombre'])."','".utf8_decode($_POST['apellidos'])."','".utf8_decode($_POST['correo'])."','".utf8_decode($_POST['telefono'])."','".$fecha."')";
				...
				<div class="list-items">
			        <div class="form-add">
			        	<form name="form1" action="" method="post" enctype="multipart/form-data">
			        		...
			        		<input type="text" name="usuario" placeholder="Nombre de usuario" value="" required>
