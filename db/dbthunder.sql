...
-- -----------------------------------------------------
-- Table `dbthunder`.`thu_empresa`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbthunder`.`thu_empresa` (
  `idthu_empresa` INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `dbthunder`.`thu_proyecto` (
  ...
  INDEX `fk_thu_proyecto_thu_empresa1_idx` (`idthu_empresa` ASC))
ENGINE = MyISAM
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `dbthunder`.`thu_empresa_contrata_paquete`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbthunder`.`thu_empresa_contrata_paquete` (
  `idthu_empresa` INT(11) NOT NULL,
  `idthu_paquete` INT(11) NOT NULL,
  PRIMARY KEY (`idthu_empresa`, `idthu_paquete`),
  INDEX `fk_thu_empresa_has_thu_paquete_thu_paquete1_idx` (`idthu_paquete` ASC),
  INDEX `fk_thu_empresa_has_thu_paquete_thu_empresa1_idx` (`idthu_empresa` ASC))
ENGINE = MyISAM
DEFAULT CHARACTER SET = utf8;
...
INSERT INTO `dbthunder`.`thu_administrador` (`idthu_administrador`, `idthu_administrador_rol`, `avatar`, `usuario`, `token`, `nombre`, `apellidos`, `nacimiento`, `correo`, `telefono`, `puesto`, `root`, `creado`) VALUES (3, 1, NULL, 'fernando', 'e10adc3949ba59abbe56e057f20f883e', 'Luis Fernando', 'Gómez del Porte', '1996-05-07 00:00:00', 'fernandogp@thundertechnology.mx', '9613289926', 'Desarrollador Web', 0, '2017-09-06 12:18:00');
INSERT INTO `dbthunder`.`thu_administrador` (`idthu_administrador`, `idthu_administrador_rol`, `avatar`, `usuario`, `token`, `nombre`, `apellidos`, `nacimiento`, `correo`, `telefono`, `puesto`, `root`, `creado`) VALUES (4, 1, NULL, 'jesus', 'e10adc3949ba59abbe56e057f20f883e', 'Jesús Afdel', 'Guzmán Luis', '1995-10-31 00:00:00', 'jesusgl@thundertechnology.mx', '9711287419', 'Desarrollador Web', 0, '2017-09-06 12:20:00');
INSERT INTO `dbthunder`.`thu_administrador` (`idthu_administrador`, `idthu_administrador_rol`, `avatar`, `usuario`, `token`, `nombre`, `apellidos`, `nacimiento`, `correo`, `telefono`, `puesto`, `root`, `creado`) VALUES (5, 1, NULL, 'cesar', 'e10adc3949ba59abbe56e057f20f883e', 'Cesar Ulises', 'Gálvez Jiménez', '1993-02-15 00:00:00', 'cesar.galvez@thundertechnology.mx', '9612785936', 'Desarrollador de Hardware', 0, '2017-09-06 12:24:00');
INSERT INTO `dbthunder`.`thu_administrador` (`idthu_administrador`, `idthu_administrador_rol`, `avatar`, `usuario`, `token`, `nombre`, `apellidos`, `nacimiento`, `correo`, `telefono`, `puesto`, `root`, `creado`) VALUES (6, 1, NULL, 'diego', 'e10adc3949ba59abbe56e057f20f883e', 'Diego de Jesús', 'Pérez Nangullasmú', '1995-01-04 00:00:00', 'diego.nangullasmu@thundertechnology.mx', '9612721257', 'Desarrollador de Hardware', 0, '2017-09-06 12:25:00');
INSERT INTO `dbthunder`.`thu_administrador` (`idthu_administrador`, `idthu_administrador_rol`, `avatar`, `usuario`, `token`, `nombre`, `apellidos`, `nacimiento`, `correo`, `telefono`, `puesto`, `root`, `creado`) VALUES (7, 1, NULL, 'joseluis', 'e10adc3949ba59abbe56e057f20f883e', 'José Luís', 'Aguilar Nucamendi', '2000-11-03 00:00:00', 'luisan@thundertechnology', NULL, NULL, NULL, NULL);
...
INSERT INTO `dbthunder`.`thu_proyecto_status` (`idthu_proyecto_status`, `idthu_administrador`, `nombre`, `creado`) VALUES (1, 1, 'En espera de aprobación', '2017-09-19 12:34:00');
INSERT INTO `dbthunder`.`thu_proyecto_status` (`idthu_proyecto_status`, `idthu_administrador`, `nombre`, `creado`) VALUES (2, 1, 'Aprobado', '2017-09-20 12:34:00');
INSERT INTO `dbthunder`.`thu_proyecto_status` (`idthu_proyecto_status`, `idthu_administrador`, `nombre`, `creado`) VALUES (3, 1, 'En proceso', '2017-09-21 12:35:00');
INSERT INTO `dbthunder`.`thu_proyecto_status` (`idthu_proyecto_status`, `idthu_administrador`, `nombre`, `creado`) VALUES (4, 1, 'Terminado', '2017-09-20 12:35:00');

INSERT INTO `thu_servicio` (`idthu_servicio`, `idthu_administrador`, `idthu_proyecto_tipo`, `portada`, `icono`, `nombre`, `introduccion`, `descripcion`, `tags`, `creado`) VALUES (1, 1, 1, '', 'icon-web-development', 'Desarrollo Web', 'Desarrollo de sistemas web y administradores de contenido a la medida de tus necesidades', 'Encuentra la solución perfecta para tus necesidades, si estás cansado de buscar plataformas que no funcionan como tu quieres o que no se adaptan completamente a tus necesidades, estás en el lugar indicado.', 'desarrollo web, tecnología, sistemas web, tuxtla gutiérrez', '2017-09-20 18:09:04');
