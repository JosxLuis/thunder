...
<head>
	<title>Empresa</title>
	<meta charset="UTF-8">
	<meta name="description" content="Empresa mexicana con 4 años de experiencia en el desarrollo de hardware y software para empresas.">
	...
	<div class="container">
		<div class="seven columns">
			<div class="box pd-ver-20">
				<br>
				<h3 class="col-white">¿Cómo surgió Thunder Technology?</h3>
				<p class="col-white">Thunder Technology surge por la necesidad de desarrollo de tecnología hecha en méxico para que los emprendedores y empresarios puedan impulsar sus negocios, realizando desarrollo de tecnología local se reducen los costos considerablemente.</p>
			</div>
		</div>
		<div class="nine columns relative">
			<div class="box ">
				<div class="about-imagen"></div>
			</div>
		</div>
	</div>
</div>
<div class="section sec-white mh-200">
		<div class="container">
			<div class="sixteen columns">
				<div class="icono">
						<a href="" class="img img-h-200 maut" style="background: url(<?php echo URL; ?>img/rayo.svg);"></a>
					</div>
				<div class="box mh-100 pd-20">
					<h3 class="tx-cen">¿Qué nos motiva?</h3>
					<p class="tx-cen">Hacemos lo que más nos gusta y lo hacemos para ayudar a hacer crecer a las empresas en México <br> contribuyendo así a mejorar la economía del país.</p>
				</div>
			</div>
			<div class="one-third column">
				<div class="box pd-all-10">
					<h4 class="tx-cen">Calidad</h4>
					<p class="">Somos minuciosos en el proceso de desarrollo de nuestros proyectos, por que todo buen trabajo debe hacerse de esa manera, es por eso que ofrecemos la mejor calidad en nuestros servicios. </p>
				</div>
			</div>
			<div class="one-third column">
				<div class="box pd-all-10">
					<h4 class="tx-cen">Costos</h4>
					<p>Precios competitivos en moneda nacional, olvídate de pagar cantidades exhorbitantes en dolares o euros, nosotros te cobramos en pesos mexicanos y te ofrecemos los mejores precios.</p>
				</div>
			</div>
			<div class="one-third column">
				<div class="box pd-all-10">
					<h4 class="tx-cen">Garantía</h4>
					<p>Nuestra filosofía es la garantía de satisfacción de nuestros clientes, te invitamos a ver nuestro portafolio y nuestro listado de clientes y ver las opiniones que ellos tienen sobre <?php echo PROYECTO; ?>.</p>
				</div>
			</div>
		</div>
</div>
<div class="section mh-400 pd-20">
	<div class="equipo">
		<div class="container">
			<div class="sixteen columns">
...
<div class="section mh-200 pd-60 sec-gray">
	<div class="tecnologias clientes">
		<div class="container">
			<div class="sixteen columns">
				<div class="box mh-100">
					<h3>Tecnología</h3>
					<p>Usamos tecnologia moderna para <br> ofrecer el mejor servicio</p>
				</div>
				<ul>
					<li><a href="#"><i class="icon-xamarin"></i></a></li>
					<li><a href="#"><i class="icon-css3"></i></a></li>
					<li><a href="#"><i class="icon-css3"></i></a></li>
					<li><a href="#"><i class="icon-html-five2"></i></a></li>
					<li><a href="#"><i class="icon-amazon"></i></a></li>
					<li><a href="#"><i class="icon-texas"></i></a></li>
				</ul>
			</div>
		</div>
	</div>
